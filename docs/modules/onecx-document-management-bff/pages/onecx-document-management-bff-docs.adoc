...
quarkus.oidc-client.client-id=onecx-document-management-ui
...
quarkus.openapi-generator.codegen.spec.onecx_document_management_svc_yaml.return-response=false
